...
(function (exports) {
    ...
    function _bindEventHandlers() {
        ...
        $('.button-next').click(function () {
            // If we are on the 1st tab then the user should have an appointment hour
            // selected.
    ...
    function _applyAppointmentData(appointment, provider, customer) {
        try {
            ...
            var appointment_date = Date.parseExact(appointment.start_datetime, 'yyyy-MM-dd HH:mm:ss');
            $('#select-date').datepicker('setDate', appointment_date);
            FrontendBookApi.getAvailableHours(appointment_date.toString('yyyy-MM-dd'));
