...
(function (exports) {
    ...
    exports.initialize = function (bindEventHandlers) {
        ...
        if (GlobalVariables.settings.user.settings.address_show == 1) {
            $('#address_show').prop('checked', true);
        } else {
            $('#address_show').prop('checked', false);
        }

        if (GlobalVariables.settings.user.settings.enable_social_login == 1) {
            $('#enable_social_login').prop('checked', true);
        } else {
            $('#enable_social_login').prop('checked', false);
        }

        if (GlobalVariables.settings.user.settings.trending == 1) {
            $('#trending').prop('checked', true);
        } else {
            $('#trending').prop('checked', false);
        }

        if (GlobalVariables.settings.user.settings.always_require_approval == 1) {
            $('#always_require_approval').prop('checked', true);
        } else {
            $('#always_require_approval').prop('checked', false);
        }

        $('#whatsapp_click_to_chat_link').val(GlobalVariables.settings.user.settings.whatsapp_click_to_chat_link);
        $('#provider_logo_url').val(GlobalVariables.settings.user.settings.provider_logo_url);
        $('#provider_moto').val(GlobalVariables.settings.user.settings.provider_moto);
        $('#max_people_in_appointment').val(GlobalVariables.settings.user.settings.max_people_in_appointment);
        $('#phone_country_code').val(GlobalVariables.settings.user.settings.phone_country_code);
        $('#latitude').val(GlobalVariables.settings.user.settings.latitude);
        $('#longitude').val(GlobalVariables.settings.user.settings.longitude);
        $('#timezone').val(GlobalVariables.settings.user.settings.timezone);
        $('#hour_format').val(GlobalVariables.settings.user.settings.hour_format);
        $('#main_image_url').val(GlobalVariables.settings.user.settings.main_image_url);
        $('#gallery_urls').val(GlobalVariables.settings.user.settings.gallery_urls);
        $('#cuisines').val(GlobalVariables.settings.user.settings.cuisines);
        $('#amenities').val(GlobalVariables.settings.user.settings.amenities);
        $('#rating').val(GlobalVariables.settings.user.settings.rating);
        $('#price_level').val(GlobalVariables.settings.user.settings.price_level);
